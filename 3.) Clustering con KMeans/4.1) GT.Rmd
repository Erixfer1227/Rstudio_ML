---
title: "DEPARTAMENTO MÁS SEGUROS EN GUATEMALA"
...
fviz_nbclust(df2, kmeans, method = "wss") # Hay que encontrar la rodilla
...
k3_2009 # me dice en qué cluster ha quedado cada uno de los estados
...
plot <- plot + theme(plot.title = element_text(family = "Arial",
                                               size = 14, face = "bold"))
...
# ESTIMAR EL NÚMERO DE CLUSTERS ####
# Elbow, silhouette o gap_stat method
fviz_nbclust(df, kmeans, method = "wss") # Hay que encontrar la rodilla
...
k3_2020 # me dice en qué cluster ha quedado cada uno de los estados
...
# Cambiar la fuente del título
plot1 <- plot1 + theme(plot.title = element_text(family = "Arial",
                                               size = 14, face = "bold"))
